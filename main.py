...
num_rating_string = driver.find_element(By.XPATH,'//*[@id="module_product_review_star_1"]/div/a').text
# print(type(num_rating))
num_rating = re.search(r'\d+', num_rating_string)
print("Number of Reviews: ", num_rating.group())
time.sleep(5)
driver.quit()
